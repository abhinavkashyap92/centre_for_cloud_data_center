...
(function($) {
  ...
  var ORBIT = {
    ...
    setupFirstSlide: function () {
      ...
      for(var temp = 1; temp < this.$slides.length ; ++temp)
      {
        this.$slides.eq(this.activeSlide + temp).css({"opacity":0})
      }
      ...
      if (!this.locked) {
        ...
        if (this.options.animation == "horizontal-slide") {
          if (slideDirection == "next") {
            ...
            // this.$slides.eq(this.activeSlide + 1).css({"opacity":0})
          }
        ...
        if (this.options.animation == "horizontal-push") {
          // console.log(this.orbitWidth)
          // this.orbitWidth = $(".vission").width()
          if (slideDirection == "next") {
            this.$slides
              .eq(this.activeSlide)
              .css({"left": this.orbitWidth, "z-index" : 3})
